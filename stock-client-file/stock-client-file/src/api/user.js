...
export const getAllIndianSubscribers = async (id) => {
  return await axios.get(
    `${process.env.REACT_APP_BACKEND_API}/user/getindiansubscribers`
  );
};

export const getAllUsSubscribers = async (id) => {
  return await axios.get(
    `${process.env.REACT_APP_BACKEND_API}/user/getussubscribers`
  );
};
